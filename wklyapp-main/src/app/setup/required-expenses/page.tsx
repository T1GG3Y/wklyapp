...
function RequiredExpensesContent() {
  ...
  const { weeklyTotal, overBudgetTotal } = useMemo(() => {
    ...
    // For now, over budget calculation would need actual spending data
    // This is a placeholder - in real implementation, compare to transactions
    const overBudget = 0;
            ...
            <div className="bg-card rounded-xl border shadow-sm overflow-hidden">
              ...
              <div className="divide-y">
                {expenses && expenses.length > 0 ? (
                  expenses.slice().sort((a, b) => (a.name || a.category).localeCompare(b.name || b.category)).map((expense) => {
